...
use super::{FileResumePlan, LOADER_BATCH_SIZE};
...
fn read_compressed(
    ...
    gz_comp_done.fetch_add(plan.stat_size, Ordering::Relaxed);
    gz_decoded_done.fetch_add(decoded_total, Ordering::Relaxed);
