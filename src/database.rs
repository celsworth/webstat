...
CREATE TABLE IF NOT EXISTS top_error_urls (
    period    TEXT    NOT NULL,
    url       TEXT    NOT NULL,
    c400      INTEGER NOT NULL DEFAULT 0,
    c401      INTEGER NOT NULL DEFAULT 0,
    c403      INTEGER NOT NULL DEFAULT 0,
    c404      INTEGER NOT NULL DEFAULT 0,
    c422      INTEGER NOT NULL DEFAULT 0,
    c429      INTEGER NOT NULL DEFAULT 0,
    c4xx      INTEGER NOT NULL DEFAULT 0,
    c500      INTEGER NOT NULL DEFAULT 0,
    c502      INTEGER NOT NULL DEFAULT 0,
    c503      INTEGER NOT NULL DEFAULT 0,
